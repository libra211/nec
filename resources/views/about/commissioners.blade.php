        ...
        <div class="row g-4">
            ...
            @else
                ...
                $commissioners = [
                    ...
                    (object)['id' => 10, 'name' => 'Hon. Gabriel Bol Deng', 'position' => 'Secretary-General', 'bio' => 'Honorable Gabriel Bol Deng is the Secretary-General of the National Elections Commission, supporting the day-to-day leadership of the Commission.', 'position_order' => 3],
