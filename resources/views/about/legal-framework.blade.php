                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="list-group list-group-flush">
                            <a href="#" class="list-group-item list-group-item-action px-0 d-flex align-items-center gap-3 border-bottom" data-track-download="const-2011" data-label="Transitional Constitution 2011">
                            ...
                            <a href="#" class="list-group-item list-group-item-action px-0 d-flex align-items-center gap-3 border-bottom" data-track-download="elections-act-2023" data-label="National Elections Act 2023">
                                <i class="fas fa-file-pdf fs-5" style="color: #dc3545;"></i>
                            ...
                            <a href="#" class="list-group-item list-group-item-action px-0 d-flex align-items-center gap-3 border-bottom" data-track-download="parties-act-2012" data-label="Political Parties Act 2012">
                                <i class="fas fa-file-pdf fs-5" style="color: #dc3545;"></i>
                            ...
                            <a href="#" class="list-group-item list-group-item-action px-0 d-flex align-items-center gap-3" data-track-download="nec-regs-2024" data-label="NEC Regulations 2024">
                                <i class="fas fa-file-pdf fs-5" style="color: #dc3545;"></i>
                                <div class="flex-grow-1"><small class="fw-semibold d-block">NEC Regulations 2024</small><small class="text-muted">PDF, 980 KB</small></div>
                                <span class="dl-count-badge badge rounded-pill bg-light text-muted" style="font-size:0.65rem;font-weight:500;">0</span>
                            </a>
                        </div>
                    </div>
