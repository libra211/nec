            ...
            <div class="col-lg-10">
                ...
                <div>
                    ...
                    <div class="bg-white p-4 rounded-3">
                        ...
                        <p class="mb-0"><i class="fas fa-map-marker-alt me-2" style="color: var(--nec-gold);"></i> NEC Headquarters (formerly Aida Hotel), Plot no. 563, Bilpam Road, Thongpiny, Juba</p>
                    </div>
                </div>
            </div>
        </div>
