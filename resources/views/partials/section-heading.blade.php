{{-- Section heading: gold icon + green label badge, with optional fading line. Align: 'left' or 'center' --}}
...
<div class="d-flex align-items-center mb-3 {{ $align === 'center' ? 'justify-content-center' : '' }}">
    ...
    <div style="flex:0 1 80px;height:2px;background:linear-gradient(to right,rgba(0,145,76,0) 0%,var(--nec-gold) 100%);margin-left:12px;"></div>
    @elseif($line && $align === 'left')
