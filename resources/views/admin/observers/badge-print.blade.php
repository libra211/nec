...
<head>
    ...
    <title>Observer Accreditation Badges - Batch Print</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .toolbar button { font-family: sans-serif; background: #166534; color: #fff; border: 0; padding: 10px 22px; border-radius: 6px; font-size: .9rem; cursor: pointer; }
        @media print {
            body { background: #fff; }
            .page { margin: 0; max-width: 100%; box-shadow: none; page-break-after: always; break-after: page; }
...
<body>
    <div class="toolbar not-print">
        <button onclick="window.print()">Print {{ $applications->count() }} Accreditation(s)</button>
    </div>
