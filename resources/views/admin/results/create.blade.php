@extends('admin.layouts.app', ['title' => 'Create Result'])

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0">Create Election Result</h2>
        ...
        <form action="{{ route('admin.results.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="election_type" class="form-control" value="{{ old('election_type') }}" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="total_votes" class="form-control" value="{{ old('total_votes') }}" min="0">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Registered Voters</label>
                    <input type="number" name="registered_voters" class="form-control" value="{{ old('registered_voters') }}" min="0">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Turnout (%)</label>
                    <input type="number" name="turnout" class="form-control" value="{{ old('turnout') }}" min="0" max="100" step="0.01">
                </div>
                <div class="col-md-6">
            ...
            <div class="mt-4">
                <button type="submit" class="btn btn-nec-green btn-lg"><i class="fas fa-save me-1"></i> Save Result</button>
            </div>
        </form>
    </div>
</div>
