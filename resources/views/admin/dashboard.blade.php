...
<div class="row g-3 mb-4">
    ...
    <div class="col-md-3 col-6"><div class="ops-card"><div class="ops-number">{{ $stats['admin_areas_with_data'] ?? 0 }}/{{ $stats['total_admin_areas'] ?? 0 }}</div><div class="ops-label">Administrative Areas Operational</div><div class="progress ops-progress"><div class="progress-bar bg-warning" style="width:{{ ($stats['total_admin_areas'] ?? 1) > 0 ? round((($stats['admin_areas_with_data'] ?? 0) / max(1, $stats['total_admin_areas'] ?? 1)) * 100) : 0 }}%"></div></div></div></div>
